<template>
    <div>
        ...
        <v-card class="mb-4">
            <v-card-text>
                <v-row>
                    <v-col cols="12" md="2" v-if="viewMode === 'flat'">
                    ...
                    <v-col cols="12" :md="viewMode === 'flat' ? 6 : 8">
        ...
        <!-- Permission Dialog -->
        <PermissionDialog ref="permissionDialog" v-model="dialog" :editing-permission="editingPermission"
            :saving="saving" :form="form" :rules="rules" :groups="groups" v-model:new-group="newGroup"
            :auto-generate-slug-from-name="autoGenerateSlugFromName" @add-group="addNewGroup" @save="savePermission"
            @close="closeDialog" />
...
export default {
    ...
    methods: {
        ...
        closeDialog() {
            ...
            this.$refs.permissionDialog?.resetValidation?.();
        },
        ...
        async savePermission() {
            // Validate form
            if (!this.$refs.permissionDialog?.validateForm) {
